    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="createinstancetest.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                               인스턴스 생성
                            </a>
            ...
            <div id="layoutSidenav_content">
               ...
               <span style="color:white"><h1 class="mt-4">Dash Board</h1></span>
                        <ol class="breadcrumb mb-4">
        <span style="color:white"<li class="breadcrumb-item active">대시보드</li></ol></span>
                        <iframe src="http://10.10.51.100:3000/" width="1390" height="600" frameborder="0"></iframe>
                        </body>
                        <br></br>
                        <div class="row">
