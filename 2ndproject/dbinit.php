 ...
 * 데이터베이스 생성
 */
$pdoDatabase = new PDO('mysql:host=192.168.1.128', $databaseUser, $databasePassword);
 ...
 * 테이블 생성
 */
$pdo = new PDO('mysql:host=192.168.1.128;dbname='.$databaseName, $databaseUser, $databasePassword);
